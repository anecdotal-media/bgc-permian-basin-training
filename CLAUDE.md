...
| 22 | Capture / edit / make every second count | Statement-dark slide carrying three escalating thoughts: "Capture more than you think you need." / "But then edit ruthlessly." / "Make every second count." Attribution: "Cut the wind-up. Start on the strongest second. Get out before they scroll." Merges what was previously two slides; "One CTA per post" dropped. |
| 23 | Thumb-stop test | "Would I stop scrolling for this?" |
| 24 | Recap card | 3 columns with big Anton numerals + distilled tag-lines (no bullet lists). Strategy / Tactics / Filters. Strategy column is now two questions (E/E/I + emotion-evoke) rather than three abstract pillars. |
| 25 | Homework | Browse-this-week reflection / capture 3 moments / post one |
